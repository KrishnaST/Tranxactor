...
public class ECommercePurchase extends IssuerTransaction{

	
	public ECommercePurchase(NPCIConnector npcon, CBSConnector cbcon, Connection dbcon, ISO8583Message issreq) {
