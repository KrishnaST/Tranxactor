...
import com.sil.npci.iso8583.util.TLV;
import com.sil.npci.server.NPCIConnector;

public class FullMagstripePurchase extends IssuerTransaction {


	public FullMagstripePurchase(NPCIConnector npcon, CBSConnector cbcon, Connection dbcon, ISO8583Message issreq) {
	...
	public void postCBSResponseDo() {
		issres.put(0, MTI.TRANS_RESPONSE);
