...
public class QuickEMVPurchase extends IssuerTransaction{

	public QuickEMVPurchase(NPCIConnector npcon, CBSConnector cbcon, Connection dbcon, ISO8583Message issreq) {
